...
# result = create_image_lists(TEST_PERCENTAGE,VALIDATION_PERCENTAGE)
# print("Done!!!")
...
def main(_):
    ...
    #定义一个summary_op ,用来汇总scalar_summary记录的所有变量
    ...
    with tf.Session() as sess:
        ...
        for i in range(STEPS):
            ...
            summary_str,_ = sess.run([merged_summary_op,train_step], feed_dict={bottleneck_input: train_bottlenecks, ground_truth_input: train_ground_truth})

            #使用summary writer 将运行中的loss值写入
